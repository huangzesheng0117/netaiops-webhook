---
name: fortigate_device_reachability_down
version: v6.3.0
family: fortigate_device_reachability_down
description: FortiGate device up metric abnormal analysis with ping, SSH and health inspection sequence.
risk_level: readonly
stage: v6.3
---
...
This Skill handles Prometheus `up` reachability alerts for FortiGate devices.
